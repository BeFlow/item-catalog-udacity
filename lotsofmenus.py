...
# Create dummy user
User1 = User(name="Julio Silva", email="julioamadobr@gmail.com",
             picture="https://bit.ly/2OJltLD"
             )
session.add(User1)
session.commit()
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                     description="A Chinese noodle "
                     " soup made of stewed or red braised beef, "
...
menuItem6 = MenuItem(user_id=1, name="Ramen", description="a noodle soup dish."
                     ...
                     " seaweed, kamaboko, and green "
                     " onions.", price="12", course="Entree",
                     restaurant=restaurant2
                     )
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     ...
                     " rice noodles called banh pho, a few "
                     " herbs, and meat.", price="$8.99",
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings",
                     description="a common Chinese"
                     " dumpling which generally consists of minced "
                     " meat and finely chopped vegetables"
...
menuItem3 = MenuItem(user_id=1, name="Gyoza",
                     description="light seasoning of Japanese "
                     " gyoza with salt and soy sauce, and in a thin gyoza "
                     " wrapper", price="$9.95", course="Entree", "\
       " restaurant=restaurant1
                     )
...
menuItem4 = MenuItem(user_id=1, name="Stinky Tofu", description="Taiwanese "
                     "dish, deep" "fried fermented tofu served with pickled "
                     " cabbage.", price="$6.99", course="Entree",
                     restaurant=restaurant1
                     )
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     description="Rich, luscious"
                     "sponge cake soaked in sweet milk and topped "
                     "with vanilla bean whipped cream"
                     "and strawberries.", price="$2.99",
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     description="Milk snow layered with honey boba,tea"
                     " jelly, grass jelly, caramel, cream, and freshly "
                     " made mochi",
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     ...
                     "garlic sauce cooked with" "fresh "
...
menuItem5 = MenuItem(user_id=1, name="Aloo Gobi Burrito",
                     ...
                     "Burrito filled with rice, garbanzo beans, "
                     "curry sauce, potatoes (aloo), fried "
...
menuItem2 = MenuItem(user_id=1, name="Chicken and Rice",
                     description="Chicken and rice", price="$4.95",
                     course="Entree", restaurant=restaurant1
                     )
...
menuItem4 = MenuItem(user_id=1, name="Choc Full O\' Mint (Smitten\'s Fresh "
                     " Mint Chip ice cream)",
                     description="Milk, cream, salt, ..., "
                     " Liquid nitrogen magic", price="$3.95", course="Dessert",
                     restaurant=restaurant1
                     )
...
menuItem5 = MenuItem(user_id=1, name="Tonkatsu Ramen", description="Noodles "
                     " in a delicious pork-based broth with a soft-boiled egg",
                     price="$7.95", course="Entree", restaurant=restaurant1
                     )
...
menuItem1 = MenuItem(user_id=1, name="Lamb Curry", description="Slow "
                     "cook that thang in a pool of tomatoes, onions "
                     "and all those" "tasty Indian spices. Mmmm.",
...
menuItem2 = MenuItem(user_id=1, name="Chicken Marsala", description="Chicken "
                     " cooked in Marsala wine sauce with mushrooms",
                     price="$7.95", course="Entree", restaurant=restaurant1
                     )
...
menuItem3 = MenuItem(user_id=1, name="Potstickers", description="Delicious "
                     " chicken and veggies encapsulated in fried dough.",
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger",
                     ...
                     "mayo and lettuce", price="$7.00", course="Entree",
                     restaurant=restaurant1
                     )
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet", description="An "
                     " unsettlingly huge amount of ripe berries turned "
                     "into frozen" "(and seedless) awesomeness", price="$2.99",
                     course="Dessert", restaurant=restaurant1
                     )
...
menuItem2 = MenuItem(user_id=1, name="Broiled salmon",
                     ...
                     " and broiled hot & fast", price="$10.95",
                     course="Entree", restaurant=restaurant1
                     )
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", description="Chicken"
                     " marinated in yoghurt and seasoned with a spicy "
                     " mix(chilli, tamarind" " among others) and slow "
...
menuItem2 = MenuItem(user_id=1, name="Cachapa", description="Golden brown, "
                     " corn-based Venezuelan pancake; usually "
                     " stuffed with queso telita "
                     " or queso de mano, and possibly lechon. ", price="$7.99",
                     course="Entree", restaurant=restaurant1
                     )
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast",
                     ...
                     "with Sesame Seeds slathered with buttery"
                     "chantrelle mushrooms", price="$5.95",
                     course="Appetizer", restaurant=restaurant1
                     )
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                     ...
                     " Italian Pork Jowl (guanciale)", price="$6.95",
                     course="Dessert",
                     restaurant=restaurant1
                     )
